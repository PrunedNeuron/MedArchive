            ...
            <div class="card">
                ...
                <form:form modelAttribute="treatment" action="/add/treatment" method="post" name="treatment"
                    ...
                    <div class="formInputContainer">
                        ...
                        <br/>
                        <input class="formInput inputText" id="diagnosisId" name="diagnosisId" type="number" min="1"
                               placeholder="12">
                    </div>
                    ...
                    <div class="formInputContainer">
                        ...
                        <br/>
                        <input class="formInput inputText" id="drugId" name="drugId" type="number" min="1"
                               placeholder="15">
                    </div>
