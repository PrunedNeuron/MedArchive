            ...
            <div class="card">
                ...
                >
                    <div class="formInputContainer">
                        ...
                        <br/>
                        <input class="formInput inputText" id="consultationId" name="consultationId" type="number"
                    ...
                    <div class="formInputContainer">
                        ...
                        <br/>
                        <input class="formInput inputText" id="illnessId" name="illnessId" type="number" min="1"
                               placeholder="15">
                    </div>
